...
const Debezium = (props: any) => {
    const { form, onClose, setMainFormValue, addConnector, edit, existingState } = props;
    const [childFormValue, setChildFormValue] = useState<any>(_.get(existingState, "value.debezium"));
    ...
    const saveConnectorConfig = (e: any) => {
        ...
        addConnector({ formFieldSelection: _.uniq(_.concat(formField, ["debezium"])), value: { ...existingState.value, ['debezium']: { ...childFormValue, ...{ id:`${datasetId}_debezium` } } }, error: false }, childFormValue)
        onSubmission({})
        onClose()
    }
            ...
            <Grid container spacing={2}>
                <Grid item sm={12}>
                    <MUIForm
                        ...
                        initialValues={{ connector_type: "debezium", ...childFormValue }}
