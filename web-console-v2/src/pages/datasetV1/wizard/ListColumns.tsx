...
import { areConflictsResolved, downloadJSONSchema, downloadJSONSchemaV1, fetchJsonSchema, flattenSchema, getFilteredData, getNesting, } from 'services/json-schema';
...
const ListColumns = (props: any) => {
    ...
    const handleDownloadButton = () => {
        ...
        if (jsonSchema && flattenedData) {
            const data = _.get(downloadJSONSchemaV1({ schema: jsonSchema }, { schema: flattenedData }), 'schema');
    ...
    return (
        <>
            {uploadLoading && <Loader loading={uploadLoading} />}
