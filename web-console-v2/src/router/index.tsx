...
import AiAssistantPage from 'pages/DatasetCreation/AiAssistant/AiAssistantPage';
...
export const routeConfigurations: RouteConfig[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: `edit/connector/list/:datasetId`,
        label: 'Connector List',
        element: <SelectConnectorPage />,
      },
      {
        path: `edit/connector/configure/:datasetId`,
        label: `Connector Configuration`,
        element: <ConnectorConfigurationPage />,
      },
      {
        path: 'edit/ingestion/meta/:datasetId',
        label: 'Ingestion',
        element: <IngestionPage />,
      },
      {
        path: 'edit/ingestion/schema/:datasetId',
        label: 'Schema Details',
        element: <SchemaDetailsPage />,
      },
      {
        path: 'edit/processing/:datasetId',
        label: 'Processing',
        element: <ProcessingPage />,
      },
      {
        path: 'edit/storage/:datasetId',
        label: 'Storage',
        element: <StoragePage />,
      },
      {
        path: 'edit/preview/:datasetId',
        label: 'Preview',
        element: <PreviewPage />,
      },
    ],
  ...
  { path: `/dashboard`, label: 'Dashboard', element: <Dashboard /> },
  {
    ...
    element: <IndividualMetricDashboards id="overallInfra" />,
  },
  {
    path: `/dashboard/ingestion`,
    label: 'Ingestion',
    element: <IndividualMetricDashboards id="ingestion" />,
  },
  {
    path: `/dashboard/api`,
    label: 'API',
    element: <IndividualMetricDashboards id="api" />,
  },
  {
    path: `/dashboard/processing`,
    label: 'Processing',
    element: <IndividualMetricDashboards id="processing" />,
  },
  {
    path: `/dashboard/storage`,
    label: 'Storage',
    element: <IndividualMetricDashboards id="storage" />,
  },
  {
  ...
  {
    path: `/connector-management/manage`,
    label: 'Manage',
    element: <ManageConnectorsPage />,
  },
  {
    path: `/alertRules`,
    label: 'Alert Rules',
  ...
  {
    path: `/datasets/metrics/:datasetId`,
    label: 'Metrics',
    element: <IndividualMetricDashboards id="individualDataset" />,
  },
  {
    ...
    <Routes>
      {filteredRoutes.map(({ path, element, children }: RouteConfig) => (
        ...
        >
          {children &&
            children.map(
              ({ path: childPath, element: childElement }: RouteConfig) => (
                <Route
                  key={`${path}-${childPath}`}
                  path={childPath}
                  element={
